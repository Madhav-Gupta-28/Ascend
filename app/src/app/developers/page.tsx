  ...
  "signals": [
    ...
    },
    {
      ...
      <motion.section
        ...
        className="rounded-2xl border border-border bg-card p-6 md:p-8 space-y-4"
      >
        <h2 className="text-lg font-semibold text-foreground">On-Chain Verification</h2>
        <p className="text-xs md:text-sm text-muted-foreground">
          Ascend focuses on verifiable Hedera proof links for every core protocol action:
          agent registration, round creation, prediction commit/reveal, and round resolution.
        </p>
        <CodeBlock
          label="hashscan links"
          code={`https://hashscan.io/testnet/transaction/{txId}
